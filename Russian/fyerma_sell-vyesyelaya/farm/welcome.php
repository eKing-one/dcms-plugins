...
echo "<center><img src='/farm/img/logo.png' alt='Ферма' /></center><br />&raquo; 移动农场游戏欢迎你！<BR/>》要开始玩，去种子店，买五颗豌豆种子，去你的床，把所有的种子都种在床上。然后给苗床浇水，等待庄稼成熟。你可以在半小时内给苗床浇水一次，浇水会使植物提前半小时成熟。记住！你床上的每一个动作都会带走几个健康单位。你现在有一百个。健康和其他信息，以及天气，位于每个页面的顶部单元。成为一个更富裕、更有经验的农民，你可以买新床、买收割机、学技能等等。祝比赛好运！<br />恭敬地，网站开发人员</div>";
echo "<div class='rowdown'>";
echo "<img src='img/garden.png' alt='' class='rpg' /> <a href='/farm/garden/'>我的床</a></div>";
