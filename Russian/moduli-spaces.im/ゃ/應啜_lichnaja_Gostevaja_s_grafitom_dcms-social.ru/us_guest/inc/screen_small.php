...
$screen_src = H."user/us_guest/screens/user_$ank[id]_file_$file[id]_small.png";
...
if (isset($screen_work[$file['id']])) {
	?>
	<a href='/user/us_guest/download/<? echo $file['id']?>/<? echo htmlspecialchars($file['name'].'.'.$file['ras'])?>'><img src="/user/us_guest/screens/user_<? echo $ank['id']?>_file_<? echo $file['id']?>_small.png" alt=""></a>
	<?
}
