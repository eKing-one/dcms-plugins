...
$temp_set['favicon']=esc(stripcslashes(htmlspecialchars($_POST['favicon'])),1);
...
echo "Ссылка на иконку сайта:<br />\n";
echo "<textarea name='favicon'>$temp_set[favicon]</textarea><br />\n";
