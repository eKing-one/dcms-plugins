...
if(isset($_SESSION['set_them2']))$set['set_them']=$_SESSION['set_them2'];
}
else if(isset($_SESSION['set_them']))$set['set_them']=$_SESSION['set_them'];
//----------------------------------------
...
if(!isset($user) || $user['level']==0)
{
if ($set['guest_select']==2)
{
echo 'На сайте идут технические работы';
exit;
}
}else{
}
