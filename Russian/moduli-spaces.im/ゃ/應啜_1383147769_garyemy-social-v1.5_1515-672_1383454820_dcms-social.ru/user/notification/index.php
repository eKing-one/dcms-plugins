...
elseif ($type == 'garem_kraj')
{
	$name = 'украл'.($avtor['pol'] == 1 ? null : 'а').' Вас к себе в гарем';
}elseif ($type == 'garem_del')
{
	$name = 'удалил'.($avtor['pol'] == 1 ? null : 'а').' Вас из своего гарем';
}elseif ($type == 'garem_yk')
{
	$name = 'украл'.($avtor['pol'] == 1 ? null : 'а').' у Вас с гарема пользователя!';
}elseif ($type == 'garem_exit')
{
	$name = 'выкупил'.($avtor['pol'] == 1 ? null : 'ась').' у Вас с гарема!';
}

if ($type == 'garem_kraj' || $type == 'garem_del' || $type == 'garem_yk' || $type == 'garem_exit') 
  {	
