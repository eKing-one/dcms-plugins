...
echo "<img src='/style/icons/str2.gif' alt='*'> <a href=\"/forum/$forum[id]/$razdel[id]/\" title='В раздел'>" . htmlspecialchars($razdel['name']) . "</a><br />\n";

echo "<img src='/style/icons/str2.gif' alt='*'> <a href=\"/forum/$forum[id]/\" title='В подфорум'>" . htmlspecialchars($forum['name']) . "</a><br />\n";
...
$set['title']='Форум - '.htmlspecialchars($them['name']); // заголовок страницы
...
mysql_query("UPDATE `notification` SET `read` = '1' WHERE `id_object` = '$them[id]' AND `type` = 'them_post_like' AND `id_user` = '$user[id]'");

mysql_query("UPDATE `notification` SET `read` = '1' WHERE `id_object` = '$them[id]' AND `type` = 'them_post_dislike' AND `id_user` = '$user[id]'");
...
echo "<img src='/style/icons/str2.gif' alt='*'> <a href=\"/forum/\">Форум</a> | <a href=\"/forum/$forum[id]/\" title='В подфорум'>" . htmlspecialchars($forum['name']) . "</a> | <a href=\"/forum/$forum[id]/$razdel[id]/\" title='В раздел'>" . htmlspecialchars($razdel['name']) . "</a><br />\n";
...
$set['title']='Форум - '.htmlspecialchars($razdel['name']); // заголовок страницы
...
echo "<img src='/style/icons/str2.gif' alt='*'> <a href=\"/forum/$forum[id]/\">" . htmlspecialchars($forum['name']) . "</a><br />\n";
...
$set['title']='Форум - '.htmlspecialchars($forum['name']); // заголовок страницы
...
echo "<a href='/forum/$forum[id]/'>" . htmlspecialchars($forum['name']) . "</a> (".mysql_result(mysql_query("SELECT COUNT(*) FROM `forum_p` WHERE `id_forum` = '$forum[id]'"),0).'/'.mysql_result(mysql_query("SELECT COUNT(*) FROM `forum_t` WHERE `id_forum` = '$forum[id]'"),0).")\n";
