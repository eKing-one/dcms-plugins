...
if ($size == '128')
{
if (is_file(H.'sys/gallery/128/'.$if_foto.'.gif'))
	{
		DownloadFile(H.'sys/gallery/128/'.$if_foto.'.gif', 'Фото.gif', ras_to_mime('gif'));
		exit;
	}
...
if ($size == '50')
{
if (is_file(H.'sys/gallery/50/'.$if_foto.'.gif'))
	{
		DownloadFile(H.'sys/gallery/50/'.$if_foto.'.gif', 'Фото.gif', ras_to_mime('gif'));
		exit;
	}
...
if (is_file(H.'sys/gallery/640/'.$if_foto.'.gif'))
	{
		DownloadFile(H.'sys/gallery/640/'.$if_foto.'.gif', 'Фото.gif', ras_to_mime('gif'));
		exit;
	}
...
if ($size == '0')
{
if (is_file(H.'sys/gallery/foto/'.$if_foto.'.gif'))
	{
		DownloadFile(H.'sys/gallery/foto/'.$if_foto.'.gif', 'Фото.gif', ras_to_mime('gif'));
		exit;
	}
