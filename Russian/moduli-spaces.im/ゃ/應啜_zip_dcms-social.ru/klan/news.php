...
$k_post=mysql_result(mysql_query("SELECT COUNT(*) FROM `clan_news` WHERE `id_clan` = '$us[id_clan]'"),0);
...
$q=mysql_query("SELECT * FROM `clan_news` WHERE `id_clan` = '$us[id_clan]' ORDER BY `time` DESC LIMIT $start, $set[p_str]");
