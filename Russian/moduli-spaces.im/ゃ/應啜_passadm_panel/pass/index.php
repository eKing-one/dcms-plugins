...
if (isset($_SESSION['adm_auth']) && $_SESSION['adm_auth']>$time || isset($_POST['chislo']) && $pass==$_POST['chislo'])
{
...
if (user_access('adm_info'))echo "<div class='main'><img src='/style/icons/str.gif' alt=''/> <a href='http://mydcms.ru'>Поддержка/Помощь</a></div>\n";
if (user_access('distribution'))echo "<div class='main'><img src='/style/icons/str.gif' alt=''/><a href='distribution.php'>Рассылка сообщений</a></div>\n";

if ($user['level'] > 3)echo "<div class='main'><img src='/style/icons/str.gif' alt=''/> <a href='/user/podarok'>Рассылка подарков</a></div>\n";
if (user_access('adm_mysql'))echo "<div class='main'><img src='/style/icons/str.gif' alt='*' /> <a href='data_base_cleaner.php'>Автоочистка базы</a></div>";
if (user_access('adm_info'))echo "<div class='main'><img src='/style/icons/str.gif' alt=''/> <a href='http://wapftp.su'>FTP Менеджер</a></div>\n";
...
echo '<b>Введите код доступа:</b><br />';
echo "</div>\n";
echo "<div class='rekl_main'>\n";
echo '<input type="password" name="chislo" /><br /><br />';
echo "</div>\n";
echo "<div class='p_t'>\n";
echo '<input type="submit" value="Далее" /></form><br />';
echo "</div>\n";
}
