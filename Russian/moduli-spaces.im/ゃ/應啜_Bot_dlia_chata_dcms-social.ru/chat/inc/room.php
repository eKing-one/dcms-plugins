...
if ($room['bot']=='1')include 'inc/bot.php';
err();
aut(); // форма авторизации
echo '<div class="guser_aut">';
echo "<a href='/chat/room/$room[id]/".rand(1000,9999)."/'>Обновить</a> | <a href='/smiles/'>Смайлы</a> | <a href='/pages/bb_code.php'><font color='red'>BB</font><font color='green'>-</font><font color='blue'>Code</font></a>\n";
echo '</div>';
...
if ($post['umnik_st']==0 && $post['shutnik']==0)
if ($ank['id']==138){
echo "<img src='/style/papka/status/gotov.png'/>\n";
}
else
{
echo "".online($ank['id'])."";
...
echo "  <td class='p_t'>\n";
if ($post['umnik_st']==0 && $post['shutnik']==0)
echo "<a href='/chat/room/$room[id]/".rand(1000,9999)."/$ank[id]/'>$ank[nick]</a> $Te6e_cyka (".vremja($post['time']).")\n";
elseif ($post['umnik_st']!=0)
