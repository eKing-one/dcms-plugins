...
echo "$num_post\n";
echo "</a>\n";
echo "<a href='/forum/$forum[id]/$razdel[id]/$them[id]/$post[id]/msg' title='Ответить $ank[nick]'>\n";
...
echo "$num_post\n";
echo "</a>\n";
echo "<a href='/info.php?id=$ank[id]' title='Анкета $ank[nick]'>\n";
echo GradientText("$ank[nick]", "$ank[ncolor]", "$ank[ncolor2]");
echo "</a>\n";
echo "".online($ank['id'])."</a>(".vremja($post['time']).")<br />\n";
}
echo "  </td>\n";
echo "   </tr>\n";
echo "   <tr>\n";
