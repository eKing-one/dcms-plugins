...
echo "<option value='4'>$set[chat_hud]</option>\n";
echo "<option value='5'>$set[chat_anagrama]</option>\n";
echo "<option value='6'>$set[chat_rebus]</option>\n";
echo "<option value='7'>$set[chat_flirt]</option>\n";
