...
} else if (mysql_result(mysql_query("SELECT COUNT(*) FROM `user` WHERE `ip` = '$iplong'"),0)!=0){
...
err();
echo "<a href='/aut.php'><div class='foot'><img src='/style/icons/str2.gif' alt=''> Авторизация</a><br />\n";
include_once 'sys/inc/tfoot.php';
}
