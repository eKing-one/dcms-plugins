...
mysql_query("INSERT INTO `logs` (`login`, `ip`, `ua`, `time`, `success`, `method`) values ('$user[nick]', '$_SERVER[REMOTE_ADDR]', '$_SERVER[HTTP_USER_AGENT]', '".time()."', '1', '1')");
header('Location: /info.php');
}
else 
{
$err='Неправильный логин или пароль';
$user2222=get_user($_GET['id']);
mysql_query("INSERT INTO `logs` (`login`, `ip`, `ua`, `time`, `success`, `method`) values ('$user2222[nick]', '$_SERVER[REMOTE_ADDR]', '$_SERVER[HTTP_USER_AGENT]', '".time()."', '2', '1')");
}
}
...
mysql_query("UPDATE `user` SET `date_aut` = ".time()." WHERE `id` = '$user[id]' LIMIT 1");
mysql_query("UPDATE `user` SET `date_last` = ".time()." WHERE `id` = '$user[id]' LIMIT 1");
mysql_query("INSERT INTO `logs` (`login`, `ip`, `ua`, `time`, `success`, `method`) values ('$user[nick]', '$_SERVER[REMOTE_ADDR]', '$_SERVER[HTTP_USER_AGENT]', '".time()."', '1', '2')");
header('Location: /info.php');
}
else
{
$err='Неправильный логин или пароль';
mysql_query("INSERT INTO `logs` (`login`, `ip`, `ua`, `time`, `success`, `method`) values ('".my_esc(htmlspecialchars($_POST['nick']))."', '$_SERVER[REMOTE_ADDR]', '$_SERVER[HTTP_USER_AGENT]', '".time()."', '2', '2')");
}
}
...
mysql_query("INSERT INTO `logs` (`login`, `ip`, `ua`, `time`, `success`, `method`) values ('$user[nick]', '$_SERVER[REMOTE_ADDR]', '$_SERVER[HTTP_USER_AGENT]', '".time()."', '1', '3')");
}
else
{
$user2222=get_user($_COOKIE['id_user']);
setcookie('id_user');
setcookie('pass');
mysql_query("INSERT INTO `logs` (`login`, `ip`, `ua`, `time`, `success`, `method`) values ('$user2222[nick]', '$_SERVER[REMOTE_ADDR]', '$_SERVER[HTTP_USER_AGENT]', '".time()."', '2', '3')");
}
}
