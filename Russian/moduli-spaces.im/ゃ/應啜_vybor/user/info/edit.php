...
echo "
 <img src='/style/icons/str.gif' alt='*'> Страна  <b>".($user['country']!=NULL? output_text($user['country']): 'Не выбрано')."</b><span style='float:right;'><a href='select.php?act=country'><font color='red'>Настроить</font></span></a></br> <img src='/style/icons/str.gif' alt='*'> Регион <b>".($user['region']!=NULL ? output_text($user['region']) : 'Не выбрано')."</b> </br> <img src='/style/icons/str.gif' alt='*'> Город </font><b>".($user['city']!=NULL ? output_text($user['city']) : 'Не выбрано')."</b></br>";
///// End
