...
include("page_head.php");      
      ...
      // generate feed URL
      $feedURL = "http://gdata.youtube.com/feeds/mobile/standardfeeds/most_viewed/?orderby={$s}&max-results=5&start-index={$o}&format=1";
      ...
      <div class="header">Наиболее рассматриваемые</div>
<div class="shout">
