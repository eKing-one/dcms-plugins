...
include("page_head.php");      
      ...
      // generate feed URL
      $feedURL = "http://gdata.youtube.com/feeds/mobile/standardfeeds/top_favorites/?orderby={$s}&max-results=5&start-index={$o}&format=1";
      ...
      <div class="header">ГЛАВНЫЕ ФАВОРИТЫ</div>
<div class="shout">
