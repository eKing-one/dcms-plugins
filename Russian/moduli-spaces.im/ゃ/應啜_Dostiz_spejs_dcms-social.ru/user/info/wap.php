...
echo "<table class='nav2'><tr><td>";
echo avatar($ank['id'], true, 128, false);


include_once 'reit/style.php'; ////// доп. стили для рейтинга
...
echo '<div class="oh">
<div>
<a class="rate_arrow" href="/reit/zadanie.php?id='.$user['id'].'">
    Рейтинг: '.$ank['ikey_reit'].' <div class="rate_arrow_end"></div>
</a></div>
</div>
';
echo '</td></tr></table>';
include_once 'reit/vivod_dost.php'; ////Выводит выполненные достижения в анкете
/* ==================== */
