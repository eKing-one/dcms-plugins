...
if ($room['umnik']==0 && $room['shutnik']==0 && $room['anagrama']==1)$sel=' selected="selected"';else $sel=NULL;
echo "<option value='4'$sel>Анаграмма</option>\n";
echo "</select><br />\n";
...
echo "<option value='4'>Анаграмма</option>\n";
echo "</select><br />\n";
...
echo "&raquo;<a href=\"?act=clear\">Очистить чат от сообщений</a><br />\n";
if (user_access('chat_room') && mysql_result(mysql_query("SELECT COUNT(*) FROM `chat_rooms`"),0)>0)
echo "&raquo;<a href=\"?act=add_room\">Создать комнату</a><br />\n";
echo "</div>\n";
?>