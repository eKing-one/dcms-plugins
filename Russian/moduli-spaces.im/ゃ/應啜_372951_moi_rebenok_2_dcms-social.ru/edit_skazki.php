...
if (!isset($err))
{
mysql_query("UPDATE `baby_shop_skazki` SET `name` = '".$name."' WHERE `id` = '".$dd['id']."' LIMIT 1");
mysql_query("UPDATE `baby_shop_skazki` SET `cena` = '".$cena."' WHERE `id` = '".$dd['id']."' LIMIT 1");
echo "<div class='msg'>";
