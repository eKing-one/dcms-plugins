...
if (isset($_GET['yes']))
{
if (is_file(H.'baby/shop_igrushki/'.$dd['id'].'.png'))
{
unlink(H.'baby/shop_igrushki/'.$dd['id'].'.png');
}
mysql_query("DELETE FROM `baby_shop_igrushki` WHERE `id` = '".$dd['id']."' LIMIT 1");
echo "<div class='msg'>";
echo "Игрушка успешно удалена!";
echo "</div>";
}else{
echo "<div class='err'>";
echo "Вы уверены что хотите удалить игрушку ".$dd['name']."?";
echo "</div>";
