...
err();
echo "<form method='post' name='message' action='?edit'>";
...
echo "</form>";
echo "<a href='set.php'><div class='foot'>";
...
{
echo "<a href='?foto&amp;del'><div class='main2'><center>";
echo "Удалить фото";
echo "</center></div></a>";
}
echo "<form method='post' enctype='multipart/form-data' action='?foto'>";
...
echo "<div class='msg'>";
echo "<b>Теперь у вас нет ребенка!</b>";
echo "</div>";
...
echo "<div class='err'>";
echo "<b>Вы уверены что хотите бросить своего ребёнка?</b>";
echo "</div>";
echo "<a href='?del&amp;yes'><div class='main2'><center>";
echo "Да, бросить";
echo "</center></div></a>";
echo "<a href='set.php'><div class='foot'>";
echo "<img src='img/home.png' alt='Simptom'> Назад";
