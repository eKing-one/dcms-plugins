...
if (isset($_GET['yes']))
{
if (is_file(H.'baby/shop_eda/'.$dd['id'].'.png'))
{
unlink(H.'baby/shop_eda/'.$dd['id'].'.png');
}
mysql_query("DELETE FROM `baby_shop_eda` WHERE `id` = '".$dd['id']."' LIMIT 1");
echo "<div class='msg'>";
echo "Еда успешно удалена!";
echo "</div>";
}else{
echo "<div class='err'>";
echo "Вы уверены что хотите удалить еду ".$dd['name']."?";
echo "</div>";
...
echo "</center></td>";
echo "<td class='main2'><center>";
echo "<a href='shop.php?eda'><img src='img/no.png' alt='Simptom'> Нет</a>";
echo "</center></td>";
echo "</tr></table>";
}
echo "<a href='shop.php?eda'><div class='foot'>";
