...
echo "<img src='/farm/img/garden.png' alt='' class='rpg' /> <a href='/farm/garden/'>我的农场</a> (到土地边去)<br/>";
echo "<img src='/farm/img/serdechko.png' alt='' class='rpg' /> <a href='/farm/dining'>食堂</a> (补充健康)<br/>";
echo "<img src='/farm/img/money.png' alt='' class='rpg' /> <a href='/farm/exchanger'>交易器</a> (游戏货币兑换商)<br/>";
